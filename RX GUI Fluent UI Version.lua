...
Tabs.Main:AddButton({
        Title = "Dash Script",
        Description = "Teleport 35 Studs Forward - Keybind is E",
        Callback = function()
            Window:Dialog({
        ...
        Title = "Script Loaded";
        Text = "Dash Script For PC Has Been Loaded Press E To Dash";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
...
Tabs.Main:AddButton({
        ...
        Description = "Summon Clones That You Teleport To - Keybind is J (2×)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Shadow Clone Jutsu For PC Has Been Loaded Press J (2×) To Activate";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
  ...
  Tabs.Main:AddParagraph({
    ...
    Tabs.Main:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Animated TP Tool Has Been Given";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Main:AddButton({
        ...
        Description = "A Tool Which Teleports You Behijd The Nearest Player (30 Studs)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Limitless Tech Tool Has Been Given";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Main:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Tp Clone Button Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Main:AddButton({
        ...
        Description = "Lock Unto The Nearest Player (75 Studs) - Keybind is Y",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Aim Lock / Cam Locl Script Has Been Loaded Press Y To Lock Unto A Nearby Player (75 Studs Near)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Main:AddButton({
        ...
        Description = "Useful For Mobile Users (Not Mine)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
    ...
    Tabs.Main:AddButton({
        ...
        Description = "Draggable Shift Lock Button (Not Mine)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
    ...
    Tabs.Expl:AddButton({
        ...
        Description = "Shows A Warning Sign Above A Player Who Used Death Counter (Not Mine)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
    ...
    Tabs.Expl:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Kill Display Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Expl:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Kill Notification Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Expl:AddButton({
        ...
        Description = "Teleports You Behind The Player Who Used Table Flip Or Omni (Not Mine And Only Works If Their 100 Studs Near)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/louismich4el/ItsLouisPlayz-Scripts/main/Auto%20Dodge%20Omni%20And%20Table.lua"))()
    ...
    Tabs.Expl:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Invis Table Flip Has Been Loaded (Re Execute If You Die)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Expl:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Invis Serious Punch Has Been Loaded (Re Execute If You Die)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Expl:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Invis Omni Has Been Loaded (Re Execute If You Die)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
...
onAnimation("16139108718", function(animation)
    wait(0.1)
    if teleportPosition == CFrame.new(150, -497, 30) then
    print("invalid move")
else
    punishTp()
end
...
Dropdown:OnChanged(function(Value)
    ...
    Tabs.Expl:AddButton({
        Title = "Manual Void",
        Description = "Teleport Players To The Void (PC Version) - Keybind is G",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Manual Void For PC Has Been Loaded Press G To Void";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Expl:AddButton({
        Title = "Manual Void",
        Description = "Teleport Players To The Void (Mobile Version)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Manual Void For Mobile Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Expl:AddButton({
        ...
        Description = "Finds Players With HP Lower Than 20 (Mobile Version)",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Kill Steal Button Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
                ...
                Buttons = {
                    {
                        Title = "Confirm",
                        Callback = function()
                            loadstring(game:HttpGet("https://raw.githubusercontent.com/Redexe19/RXGUIV1/refs/heads/main/SavageTornadoBringAllReExecuteOnDeath"))()
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Savage Tornado Bring All Has Been Loaded (Re Execute If You Die)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
...
loadstring(game:HttpGet("https://pastebin.com/raw/Y3uyGSK6"))()
    ...
    Tabs.Char:AddButton({
        ...
        Description = "Made By I.Am.Agent",
        Callback = function()
            Window:Dialog({
                Title = "Execute This Script?",
                Content = "Y/N",
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/zyrask/Nexus-Base/main/atomic-blademaster%20to%20sukuna"))()
    ...
    Tabs.Char:AddButton({
        Title = "Saitama To Mahito",
        Description = "Made By Kenjihin69",
        Callback = function()
            Window:Dialog({
                Title = "Execute This Script?",
                Content = "Y/N",
    ...
    Tabs.Char:AddButton({
        Title = "Garou To Shinjuku Yuji",
        Description = "Made By xVicity",
        Callback = function()
            Window:Dialog({
                Title = "Execute This Script?",
                Content = "Y/N",
    ...
    Tabs.Char:AddButton({
        Title = "Saitama To Deku",
        Description = "Made By TitanCameraWomem",
        Callback = function()
            Window:Dialog({
                Title = "Execute This Script?",
                Content = "Y/N",
    ...
    Tabs.Char:AddButton({
        Title = "Tatsumaki To Sans",
        Description = "Made By Qaiddanial2904",
        Callback = function()
            Window:Dialog({
                Title = "Execute This Script?",
                Content = "Y/N",
...
character.AncestryChanged:Connect(function(_, parent)
    ...
    Tabs.Play:AddButton({
        Title = "Noclip",
        Description = "Toggle Collision - Keybind = T",
        Callback = function()
            Window:Dialog({
                Title = "Execute Script?",
                Content = "Y/N",
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Noclip Has Been Loaded (Re Execute If You Die) (Didnt Get Changed To A Toggle Cause Of Buggy Character)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Play:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "No Stun Has Been Loaded (Re Execute If You Die)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Play:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "No Ragdoll Has Been Loaded (Re Execute If You Die)";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Play:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Animation GUI Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Play:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Animation Tool Has Been Given";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Redexe19/RXGUIV1/main/posdisplayer"))()
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "Position Displayer Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
    ...
    Tabs.Misc:AddButton({
        ...
        game.StarterGui:SetCore("SendNotification", {
        Title = "Script Loaded";
        Text = "FPS Boost Has Been Loaded";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
...
camera.FieldOfView = wantedforgamingFOV
    ...
    Tabs.Misc:AddButton({
        ...
        Text = "YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK,YOU CANT GO BACK";
        Duration = 4;
        Button1 = "Okay.";
})
                        end
...
-- Assuming you have a UI library with "Tabs" and "Toggle" objects
local Toggle = Tabs.Misc:AddToggle("KickOnDeath", {Title = "Kick On Death", Default = false })

-- Change the toggle state when it's clicked
Toggle:OnChanged(function(enabled)
    if enabled then
        character:FindFirstChild("Humanoid").HealthChanged:Connect(function(health)
            if health <= 0 then
                randomIndex = math.random(1, #deathFunctions)
                deathFunctions[randomIndex]()
            end
        end)
    else
        character:FindFirstChild("Humanoid").HealthChanged:Disconnect()
    end
end)
